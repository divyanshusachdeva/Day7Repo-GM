...
public class Assignment {
    ...
    public static void main(String[] args) {
        ...
        // 2. Lambda expression to find the average of a list of doubles
        ...
        // 3. Lambda expression to check if a number is prime
        ...
        // 4. Lambda expression to concatenate two strings
        BiFunction<String, String, String> concatenate = (s1, s2) -> s1 + s2;
        System.out.println(concatenate.apply("Hello", "World"));

        
        // 5. Lambda expression to count the words in a paragraph
        ...
        // 6. Person class using collections
